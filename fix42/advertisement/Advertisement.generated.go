...
func (m Advertisement) GetSymbolSfx() (v string, err quickfix.MessageRejectError) {
...
func (m Advertisement) GetTradingSessionID() (v string, err quickfix.MessageRejectError) {
