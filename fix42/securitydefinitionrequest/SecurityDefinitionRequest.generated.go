...
func (m SecurityDefinitionRequest) GetSymbolSfx() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityDefinitionRequest) GetTradingSessionID() (v string, err quickfix.MessageRejectError) {
