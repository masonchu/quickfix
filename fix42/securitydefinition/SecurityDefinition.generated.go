...
func (m SecurityDefinition) GetSymbolSfx() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetTradingSessionID() (v string, err quickfix.MessageRejectError) {
